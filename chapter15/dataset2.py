if __name__ == '__main__':
    ...
    data_root = pathlib.Path('..//data_set//UCMerced_LandUse')
    ...
    def load_process_img(img_path):
        ...
        # img_tensor = tf.image.decode_jpeg(img_tensor1, channels=3)
        # 更改图片的大小
        img_tensor = tf.image.resize(img_tensor,(64, 64,3))
        # 转换类型
    ...
    # model.add(tf.keras.layers.Conv2D(filters=64, kernel_size=(3, 3),padding='same', input_shape=(64, 64, 3), activation='relu'))
