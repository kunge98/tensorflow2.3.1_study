if __name__ == '__main__':
    ...
    #或者用绝对路径'F:\\PythonStudy\\project\\tensorflow2.3.1\\data_set\\2_class'
    ...
    #     all_img_label = [label_to_index[pathlib.Path(i).parent.name]]

    #验证一下输出的类名和数字编码是否对应
    # print(all_img_label[:5])
    ...
    # img = load_preprocess_img('../data_set/2_class/airplane/airplane_001.jpg')
